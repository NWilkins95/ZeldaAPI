...
router.get('/', handleErrors(charactersController.getAll));

// Route to get a single character by ID
router.get('/:id', handleErrors(charactersController.getSingle));
...
router.delete('/:id', handleErrors(charactersController.deleteCharacter));
